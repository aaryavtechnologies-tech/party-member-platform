    ...
    <>
      {variant === "icon" ? (
        ...
        <Button
          variant="outline"
          onClick={() => setIsOpen(true)}
          className="flex-1 md:flex-none flex items-center justify-center gap-2 bg-red-50 hover:bg-red-100 text-red-600 dark:bg-red-950/40 dark:hover:bg-red-900/60 dark:text-red-400 border-red-200 dark:border-red-900/50 font-bold"
        >
        ...
        <button
          type="button"
          onClick={() => setIsOpen(true)}
          className="w-full text-left px-3 py-2 text-sm text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-950/50 rounded-md flex items-center gap-2 font-medium"
        >
          <Trash2 className="w-4 h-4" /> Delete Member
        </button>
      )}
