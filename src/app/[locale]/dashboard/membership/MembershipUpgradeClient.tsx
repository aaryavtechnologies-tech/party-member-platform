...
export function MembershipUpgradeClient({ currentTier }: { currentTier: string }) {
  ...
  if (currentTier === "LIFETIME_ACTIVE") {
    return (
      <div className="max-w-5xl mx-auto space-y-8">
        <div className="text-center max-w-2xl mx-auto mb-12">
          ...
          <h1 className="text-3xl font-bold text-slate-900 dark:text-white mb-4">You're at the Top Tier!</h1>
          <p className="text-slate-500">You are already a Lifetime Active Member. You have access to all features and benefits of the platform.</p>
    ...
    <div className="max-w-5xl mx-auto space-y-8">
      ...
      <div className="bg-white dark:bg-slate-900 rounded-3xl p-8 border border-slate-100 dark:border-slate-800 shadow-sm mb-12">
        ...
        <div className="flex items-center justify-between relative">
          ...
          <div className={`absolute left-0 top-1/2 -translate-y-1/2 h-1 bg-primary -z-10 rounded-full transition-all ${currentTier === 'LIFETIME_PRIMARY' ? 'w-2/3' : 'w-1/3'}`} />
          ...
          <div className="flex flex-col items-center gap-3">
            <div className={`w-10 h-10 rounded-full flex items-center justify-center transition-colors ${currentTier === 'LIFETIME_PRIMARY' ? 'bg-primary text-slate-950 shadow-lg shadow-primary/30' : 'bg-white dark:bg-slate-800 border-2 border-primary text-primary'}`}>
              {currentTier === 'LIFETIME_PRIMARY' ? <CheckCircle2 className="w-5 h-5" /> : <Shield className="w-5 h-5" />}
            </div>
