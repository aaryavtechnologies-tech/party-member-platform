// src/app/[locale]/organization/district/page.tsx
...
export default async function DistrictTeamPage() {
  const admins = await getAdminsByRole(AdminRole.DISTRICT_ADMIN);
  ...
  return (
    <section className="p-6 min-h-screen bg-gray-50 dark:bg-slate-900">
      <h1 className="text-3xl font-bold text-center mb-8 text-primary">District Team</h1>
