...
export default function WomenPolicyPage() {
  const tNav = useTranslations("Navigation");
  const t = useTranslations("womenPolicyPageContent");
    ...
    <main>
      <InnerPageHeader 
        ...
        breadcrumbs={[
          ...
          { label: t("title"), href: "/policies/women" }
        ]}
      />
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          <div className="mb-24 flex justify-center">
             <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-8 md:p-12 rounded-3xl shadow-xl max-w-4xl w-full">
              ...
              <p className="text-xl text-slate-600 dark:text-slate-400 mb-6 text-center">{t("vision_p1")}</p>
              <div className="grid sm:grid-cols-2 gap-4">
                {t.raw("visions").map((vision: string, idx: number) => (
                  <div key={idx} className="flex items-center space-x-3 text-lg font-medium p-4 bg-slate-50 dark:bg-slate-950 rounded-2xl">
