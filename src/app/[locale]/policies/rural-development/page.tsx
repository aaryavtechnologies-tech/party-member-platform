...
export default function RuralDevelopmentPolicyPage() {
  ...
  return (
    <main>
      <InnerPageHeader 
        title={t("subpages.rural_development")} 
        breadcrumbs={[
          { label: tNav("policies"), href: "/policies" },
          { label: t("subpages.rural_development"), href: "/policies/rural-development" }
        ]}
      />
